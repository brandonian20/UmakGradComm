...
@section('content')
    ...
    <section class="pt-lg-100 pb-100 mt-lg-100 pt-50 mt-50">
           ...
           <div class="container">
             <div class="row"> 
                <div class="col-lg-8 col-12 text-lg-start text-center align-text-between">
                   ...
                   <h1 style="font-family: Marcellus; color: #d5ac44;">Message from the OIC President and Concurrent Vice President for Academic Affairs</h1>
           ...
           <div class="container">
             <div class="d-sm-flex align-items-center justify-content-between">
               <div class="row">
                 ...
                 <!-- <h1>Become a <span class="text-warning">Web Developer</span></h1> -->
                 <p class="lead my-4 text-justify" style="font-family: Metropolis; "> 
                   We focus on teaching our students the fundamentals of the latest,<br>
                 ...
                 <h3 style="font-family: Marcellus;"><br>Professor Ederson DT. Tapia, PhD. DPA</h3>
                 </div>
