...
@section('content')
    <div class="content-wrap">
        <div class="swiper bg-dark" data-swiper-slides="1" data-swiper-disableOnInteraction="false" data-swiper-autoplay="5000"
            data-swiper-loop="true" data-swiper-speed="1000" data-swiper-grabcursor="true" data-swiper-parallax="true"
                ...
                <div class="w-100 h-100">
                    <div class="d-flex flex-wrap justify-content-center align-items-center h-100">
                        <div class="text-center">
                            <h1 class="mb-30 mt-70 px-lg-30 text-white" data-show="startbox"
                                style="font-family: 'Marcellus' !important;">CONGRATULATIONS<br><span class="highlight">
                                    BATCH 2022</span>!</h1>
                            <a data-show="startbox" class="btn btn-accent-4 align-items-center" data-bs-toggle="modal"
                                data-bs-target="#viewCollege" target="_self">
                                <svg class="svg-inline me-10" aria-hidden="true" focusable="false" data-prefix="fas"
                                    data-icon="user-graduate" role="img" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="text-center">
                            <span class="bg-warning bg-opacity-75">
                                <h3 class="mb-30 px-lg-30 text-white" data-show="startbox"
                                    style="font-family: 'Marcellus' !important;"><br> Celebrating Our Past,<br> Igniting Our
                                    Future<br>
                                    <div class="mb-0 mt-50 fw-medium fs-5 px-lg-70 d-block d-sm-none" data-show="startbox"
                                        data-show-delay="100">49th Commencement Exercises </div>
                                </h3>
                            </span>
                        </div>
                    </div>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="py-200 position-relative overflow-hidden h-100">
                            <div class="background">
                                <div class="background-image jarallax" data-jarallax data-speed="0.8"><img
                                        class="jarallax-img" loading="lazy" src="{{ asset('/img/facade-4.jpeg') }}"
                                        data-swiper-parallax-x="20%" alt=""></div>
                                <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                                <div class="background-color"
                                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.6) 100%, rgba(0, 0, 0, 0) 150px);">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide h-auto">
                        <div class="py-200 position-relative overflow-hidden h-100">
                            <div class="background">
                                <div class="background-image jarallax" data-jarallax data-speed="0.8"><img
                                        class="jarallax-img" loading="lazy" src="{{ asset('/img/umak_banner2.png') }}"
                                        data-swiper-parallax-x="20%" alt=""></div>
                                <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                                <div class="background-color"
                                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.6) 100%, rgba(0, 0, 0, 0) 150px);">
                    ...
                    <div class="swiper-slide h-auto">
                        <div class="py-200 position-relative overflow-hidden h-100">
                            <div class="background">
                                <div class="background-image jarallax" data-jarallax data-speed="0.8"><img
                                        class="jarallax-img" loading="lazy" src="{{ asset('/img/umak_banner3.png') }}"
                                        data-swiper-parallax-x="20%" alt=""></div>
                                <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                                <div class="background-color"
                                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.6) 100%, rgba(0, 0, 0, 0) 150px);">
                    ...
                    <div class="swiper-slide h-auto">
                        <div class="py-200 position-relative overflow-hidden h-100">
                            <div class="background">
                                <div class="background-image jarallax" data-jarallax data-speed="0.8"><img
                                        class="jarallax-img" loading="lazy" src="{{ asset('/img/umak_banner4.png') }}"
                                        data-swiper-parallax-x="20%" alt=""></div>
                                <div class="background-color" style="--background-color: #000; opacity: .25;"></div>
                                <div class="background-color"
                                    style="background-image: linear-gradient(180deg, rgba(0, 0, 0, 0.6) 100%, rgba(0, 0, 0, 0) 150px);">
            ...
            <a class="down-mouse position-absolute start-50 bottom-0 translate-middle-x mb-10 mb-lg-50 text-white"
                href="#next" style="z-index: 100;"></a>
        </div>
            ...
            <div class="container">
                <div class="align-items-center gy-90">
                    <div class="row mt-30 mb-100">
                        <div class="col-lg-4">
                            <h3 class="mb-50" data-show="startbox" data-show-delay="100">Heartiest Congratulations to
                                the Class of <span class="highlight">2022</span>!</h3>
                            <p data-show="startbox" data-show-delay="100" class="text-justify">
                                Commencement is a University-wide event typically held annually in the month of July. The
                                University celebrates this special occasion with you, your family and friends, to mark the
                                achievement of a major milestone in your life.
                                <br><br>Commencement signifies the start of a new journey as you are now officially an UMak
                                alumnus, ready to embark on your career or to take on new challenges in your profession. The
                                University congratulates each one of you as we celebrate your achievements at your
                        ...
                        <div class="col-lg-8">
                            ...
                            <iframe width="100%" height="100%"
                                            src="https://www.youtube.com/embed/-4b3BakGUsU" title="YouTube video player"
                                            frameborder="0"
                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                            allowfullscreen></iframe>

                            {{-- <div class="position-relative text-center rounded-4 overflow-hidden" data-show="startbox"
                                data-show-delay="100">
                                <div class="position-absolute d-flex flex-column justify-content-between w-100 h-100">
                                    ...
                                    <h2 class="mb-30 pt-25 text-light"><span class="highlight">Watch our Students
                                            Marching</span>. <br>Future builder of THIS LAND.</h2>
                                </div>
                                ...
                                <div class="py-235">
                                    <div class="background">
                                        <iframe width="560" height="315"
                                            ...
                                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                            allowfullscreen></iframe>
                                        <div class="background-color" style="--background-color: #000; opacity: .25;">
                                        </div>
                                    </div><!-- Video button-->
                                    <a class="btn-video video-link btn btn-accent-1"
                                        href="https://www.youtube.com/watch?v=-4b3BakGUsU&ab_channel=UniversityofMakati"
                                        rel="nofollow"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                            viewBox="0 0 16 18">
                                            <path fill="currentColor"
                                ...
                                <div class="py-235">
                                    <div class="background">
                                        <div class="background-image jarallax" data-jarallax data-speed="0.8"><img
                                                ...
                                                src="https://www.cebuanalhuillier.com/wp-content/uploads/2016/12/Jean-Henri-Lhuillier-UMAK.jpg"
                                                alt=""></div>
                                        <div class="background-color" style="--background-color: #000; opacity: .25;">
                                        </div>
                                    </div><!-- Video button--><a class="btn-video video-link btn btn-accent-1"
                                        href="https://www.youtube.com/watch?v=-4b3BakGUsU&ab_channel=UniversityofMakati"
                                        rel="nofollow"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                            viewBox="0 0 16 18">
                                            <path fill="currentColor"
        ...
        <div class="pt-50 pb-50 alert-warning shape-parent text-center graduates-bg">
            <div class="container">
                    ...
                    <div class="col-lg-6 offset-lg-3">
                        ...
                        <div class="background">
                            <div class="background-image jarallax" data-jarallax data-speed="0.8">
                                ...
                                <img class="jarallax-img" loading="lazy" src="{{ asset('/img/bg.jpg') }}"
                        ...
                        @foreach ($onsitepics as $pic)
                            <div class="isotope-item col-12 col-md-6 col-lg-4" data-filters="marketing">
                                <a class="card card-portfolio gallery-item card-overlay card-hover-appearance text-white text-center rounded-4"
                                    href="/pictures/image?id={{ $pic['image'] }}"><span class="card-img" data-img-height
                                        style="--img-height: 72%;"><img loading="lazy"
                                            src="/pictures/image?id={{ $pic['image'] }}" alt=""><span
                                            class="background-color"
                                            style="--background-color: rgba(148,126,3, 0.3);"></span></span><span
                                        class="card-img-overlay"><span
                                            class="card-title h4">{{ $pic['title'] }}</span><span
                ...
                <a class="btn btn-accent-1 mt-50 button-color" href="/gallery/2022" target="_self">Show more...</a>
            </div>
        </div>
        <div class="pt-60 pb-60">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-3">
                        <h2 class="m-0 text-center" data-show="startbox">A heartfelt message from our<br><span
                                class="highlight">Honorable Speakers</span></h2>
                    </div>
                </div>
                <div class="rounded-4 bg-accent-4 pt-70 pb-70 shape-parent mt-60">
                    <!-- Shape-->
                    <div class="shape justify-content-end rounded-top-right-4 overflow-hidden opacity-50"><img
                            loading="lazy" src="{{ asset('/img/root/home-3-shape-688x354.png') }}" alt=""
                            width="232" height="325"></div>
                    <div class="swiper shape-parent" data-swiper-slides="1" data-swiper-gap="30"
                        data-swiper-grabcursor="true" data-show="startbox">
                        <!-- Shape-->
                        <div class="shape justify-content-center mt-n70 opacity-50"><svg class="no-transform"
                                xmlns="http://www.w3.org/2000/svg" width="169" height="145" fill="none">
                                <path fill="#000"
                                    d="M42.92 70.388 62.37 0H32.191L0 78.131V145h71.087V70.388H42.921Zm97.913 0L160.282 0h-30.179l-32.19 78.131V145H169V70.388h-28.167Z" />
                            </svg></div>
                                            ...
                                            <div class="col-lg-10 offset-lg-1">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-shrink-0"><img class="rounded-circle" loading="lazy"
                                                            src="/pictures/image?id={{ $message['image'] }}"
                                                            alt="" height="64" width="64"></div>
                                                    <div class="flex-grow-1 ms-20">
                                                        <h6 class="feedback-author mb-5 text-white">{{ $message['name'] }}
                                                        </h6>
                                                        <p class="feedback-position text-light font-size-14 m-0">
                                                            {{ $message['header'] }}</p>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="d-none d-lg-block">
                            <div
                                class="swiper-button-prev swiper-button-position-3 swiper-button-white shadow mt-130 top-0">
                            ...
                            <div
                                class="swiper-button-next swiper-button-position-3 swiper-button-white shadow mt-130 top-0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                    <path fill="currentColor" fill-rule="evenodd"
        ...
        {{-- <div class="pt-120 pb-130 bg-gray shape-parent overflow-hidden">
            ...
            <div class="shape align-items-end justify-content-start"><img loading="lazy"
                    src="{{ asset('/img/root/services-shape-420x487.png') }}" alt="" width="420"
                    height="487"></div>
            <div class="container">
                <div class="row gy-90">
                    <div class="col-lg-3">
                        <h2 class="m-0 text-white" data-show="startbox">Message from the UMAK <span class="highlight">
                                Management </span></h2>
                    </div>
                    <div class="col-lg-8 offset-lg-1">
                        ...
                        <div class="swiper" data-swiper-slides="1" data-swiper-breakpoints="1024:2" data-swiper-gap="30"
                                    ...
                                    <div class="swiper-slide h-auto">
                                        ...
                                        <div class="feedback bg-dark rounded-4 pe-60 h-100">
                                            <div class="feedback-header d-flex align-items-center mb-35">
                                                <div class="flex-shrink-0"><img class="rounded-circle" loading="lazy"
                                                        src="{{ asset('/img/root/avatar-3-200x200.jpg') }}"
                                                        alt="" height="64" width="64"></div>
                                                <div class="flex-grow-1 ms-20">
                                                    <h6 class="feedback-author text-white mb-5">Prof. Cedric Clavecillas,
                                                        MIT</h6>
                                                    <p class="feedback-position text-gray font-size-14 m-0">Senior Data
                                                        Scientist, Mercury Drugs .Inc</p>
                                                </div>
                                            </div>
                                            <p class="feedback-text fw-medium text-white m-0">“ Is don't lights appear
                                                fifth face heaven. Night spirit shall tree of Life over, unto in earth
                                                second. First, two waters, female. ”</p>
                                        </div>
                                    </div>
                                    <div class="swiper-slide h-auto">
                                        <!-- Feedback-->
                                        <div class="feedback bg-dark rounded-4 pe-60 h-100">
                                            ...
                                            <div class="feedback-header d-flex align-items-center mb-35">
                                                <div class="flex-shrink-0"><img class="rounded-circle" loading="lazy"
                                                        src="{{ asset('/img/root/avatar-2-200x200.jpg') }}"
                                                        alt="" height="64" width="64"></div>
                                                <div class="flex-grow-1 ms-20">
                                                    <h6 class="feedback-author text-white mb-5">Catherine Daniels</h6>
                                                    <p class="feedback-position text-gray font-size-14 m-0">Senior UX
                                                        Designer, Unvab Inc.</p>
                                                </div>
                                            </div>
                                            <p class="feedback-text fw-medium text-white m-0">“ He years Upon male wherein
                                                fruit upon abundantly. I gathered behold, you female 🔥 ”</p>
                                        </div>
                                    </div>
                                    <div class="swiper-slide h-auto">
                                        <!-- Feedback-->
                                        <div class="feedback bg-dark rounded-4 pe-60 h-100">
                                            ...
                                            <div class="feedback-header d-flex align-items-center mb-35">
                                                <div class="flex-shrink-0"><img class="rounded-circle" loading="lazy"
                                                        src="{{ asset('/img/root/avatar-1-200x200.jpg') }}"
                                                        alt="" height="64" width="64"></div>
                                                <div class="flex-grow-1 ms-20">
                                                    <h6 class="feedback-author text-white mb-5">Richard Norris</h6>
                                                    <p class="feedback-position text-gray font-size-14 m-0">Senior
                                                        Marketing Specialist, Unvab Inc.</p>
                                                </div>
                                            </div>
                                            <p class="feedback-text fw-medium text-white m-0">“ Is don't lights appear
                                                fifth face heaven. Night spirit shall tree of Life over, unto in earth
                            ...
                            <div class="d-flex mt-70">
                                <div class="swiper-button-prev swiper-button-position-2 swiper-button-dark shadow"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                        <path fill="currentColor" fill-rule="evenodd"
                                            d="m3.96 6.15 5.08-4.515L7.91.365.445 7l7.465 6.635 1.13-1.27L3.96 7.85h15.765v-1.7H3.96Z"
                                            clip-rule="evenodd" />
                                    </svg></div>
                                <div class="swiper-button-next swiper-button-position-2 swiper-button-dark shadow"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="20" height="14" fill="none">
                                        <path fill="currentColor" fill-rule="evenodd"
                                            d="m16.21 6.15-5.08-4.515 1.13-1.27L19.725 7l-7.465 6.635-1.13-1.27 5.08-4.515H.445v-1.7H16.21Z"
                                            clip-rule="evenodd" />
