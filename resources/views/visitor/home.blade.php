            ...
            <div class="w-100 h-100">
                <div class="d-flex flex-wrap justify-content-center align-items-center h-100">
                    <div class="text-center">
                        <h1 class="mb-30 mt-70 px-lg-30 text-white" data-show="startbox" style="font-family: 'Marcellus' !important;">CONGRATULATIONS<br><span class="highlight"> BATCH 2022</span>!</h1>
                    ...
                    <div class="text-center">
                        <span class="bg-warning bg-opacity-75">
                            <h3 class="mb-30 px-lg-30 text-white" data-show="startbox" style="font-family: 'Marcellus' !important;"><br> Celebrating Our Past,<br> Igniting Our Future<br><div class="mb-0 mt-50 fw-medium fs-5 px-lg-70 d-block d-sm-none" data-show="startbox" data-show-delay="100">49th Commencement Exercises </div></h3>
                        </span>
                    </div>
                </div>
            </div>
