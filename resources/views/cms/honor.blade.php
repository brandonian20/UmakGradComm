                    ...
                    <div class="modal-body">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control"
                                id="honorName" name="honorName" placeholder="Name" required>
            ...
            <div class="modal-content">
                <form id="editForm">
                    ...
                    <div class="modal-body">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control"
                                id="e-honorName" name="e-honorName" placeholder="Desc" required>
                            <label for="e-honorName">Name</label>
                        </div>
                    </div>
                    <div class="modal-footer border-0">
                        <button class="btn btn-light" type="button" data-bs-dismiss="modal">Close</button>
        ...
        $(function() {
            ...
            function getedit(id) {
                ...
                $.ajax({
                    ...
                    type: 'GET',
                    success: function(resp) {
                        $("#editTitle").html(`Editing <b>${resp.honorName}</b>`);

                        $("[name='e-honorName']").val(resp.honorName);
